...
//		System.out.println("Entered in Goal");
	...
	public String visit(MainClass n, IDnType idTypes) {
		...
		if (idTypes.className.contains(f1Result))
			...
			idTypes.classFieldsIndx.put(f1Result, new HashMap<String, Integer>());
			idTypes.classMethodsIndx.put(f1Result, new HashMap<String, Integer>());
			idTypes.classFieldsCnt.put(f1Result, 1);
			idTypes.classMethodsCnt.put(f1Result, 0);
...
//		int currentMethodIndx = idTypes.classMethodsCnt.get(idTypes.curClass);
//		idTypes.classMethodsIndx.get(idTypes.curClass).put("main", currentMethodIndx);
//		idTypes.classMethodsCnt.put(idTypes.curClass, currentMethodIndx + 1);
...
//		String f11Result =  n.f11.accept(this, idTypes);
//		ArrayList<String> mainParamsName = new ArrayList<>();
//		mainParamsName.add(f11Result);
//		idTypes.methodParamName.get(idTypes.curClass).put("main", mainParamsName);
//		ArrayList<String> mainParamsType = new ArrayList<>();
//		mainParamsType.add("stringArray");
//		idTypes.methodParamName.get(idTypes.curClass).put("main", mainParamsType);
		...
		HashMap<String, String> classMethod = idTypes.classMethods.get(f1Result);
		classMethod.put("main", "void");
		HashMap<String, ArrayList<String>> methodParamName = idTypes.methodParamName.get(f1Result);
		methodParamName.put("main", new ArrayList<>(Arrays.asList(f11Result)));
		HashMap<String, ArrayList<String>> methodParamType = idTypes.methodParamType.get(f1Result);
		methodParamType.put("main", new ArrayList<>(Arrays.asList("stringArray")));
		idTypes.methodVar.put("main", new HashMap<String, String>());
		int curMethodIndx = idTypes.classMethodsCnt.get(idTypes.curClass);
		idTypes.classMethodsIndx.get(idTypes.curClass).put("main", curMethodIndx);
		idTypes.classMethodsCnt.put(idTypes.curClass, curMethodIndx + 1);
...
//		System.out.println("ClassExtendsDeclaration ID1: " + f1Result);
//		System.out.println("ClassExtendsDeclaration ID2: " + f3Result);
...
//			System.out.println("ClassExtendsDeclaration: " + f1Result);
	...
	public String visit(VarDeclaration n, IDnType idTypes) {
		...
		//System.out.println("VariableDeclaration current method: " + idTypes.curMethod);
		...
		// Case 2. Put id and types into "current class".
			...
			if (idTypes.classFields.containsKey(curSearchClass) && !idTypes.classFields.get(curSearchClass).containsKey(f1Result)) {
				...
				int currentFieldIndx = idTypes.classFieldsCnt.get(idTypes.curClass);
				idTypes.classFieldsIndx.get(idTypes.curClass).put(f1Result, currentFieldIndx);
				idTypes.classFieldsCnt.put(idTypes.curClass, currentFieldIndx + 1);
			}
			else {
	...
	public String visit(MethodDeclaration n, IDnType idTypes) {
		...
		int currentMethodIndx = idTypes.classMethodsCnt.get(idTypes.curClass);
		idTypes.classMethodsIndx.get(curClass).put(f2Result, currentMethodIndx);
		
		
		//System.out.println("Assign methodDec f2Result: " + f2Result);
		
		
		idTypes.classMethodsCnt.put(curClass, currentMethodIndx + 1);
		...
		if (!idTypes.curClass.equals("")) {
			...
			if (!idTypes.childToParent.get(curClass).equals("")) {
				...
				if (idTypes.classMethods.containsKey(parentClass)) {
...
//			System.out.println("Assign FormalParameter ID: " + f1Result);
//			System.out.println("Assign FormalParameter currentClass: " + currentClass);
//			System.out.println("Assign FormalParameter currentMethod: " + currentMethod);
